...
// MODELS
use App\Http\Models\API\Entities\M_entities as M_default;


class C_entities extends Controller{

    private $module = "entity";
    private $create_required = ['status','created_by'];
    // private $create_user_chains = ['m_entities','m_entity_details'];

/************* CREATE  *************/

    // [POST] api/entity <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/entities <-- Get all lists
    ...
    // [GET] api/entity/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/entity/{id} <-- Update specific row
    ...
    // [PUT] api/entity/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/entity/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/entity/delete/{id} <-- Permanent delete specific row
