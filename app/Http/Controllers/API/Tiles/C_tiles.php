...
// MODELS
use App\Http\Models\API\Tiles\M_tiles as M_default;


class C_tiles extends Controller{
...
/************* GET/READ  *************/
    ...
    // [GET] api/tile/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/tile/{id} <-- Update specific row
    ...
    // [PUT] api/tile/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/tile/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/tile/delete/{id} <-- Permanent delete specific row
