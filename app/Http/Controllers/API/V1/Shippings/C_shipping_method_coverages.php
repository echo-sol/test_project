...
// MODELS
use App\Http\Models\API\V1\Shippings\M_shipping_method_coverages as M_default;


class C_shipping_method_coverages extends Controller{

    private $module = "shipping_method_coverage";
    private $create_required = ['shipping_method_id','status','created_by'];

/************* CREATE  *************/

    // [POST] api/shipping/method/coverage <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/shipping/method/coverages <-- Get all lists
    ...
    // [GET] api/shipping/method/coverage/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/shipping/method/coverage/{id} <-- Update specific row
    ...
    // [PUT] api/shipping/method/coverage/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/shipping/method/coverage/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/shipping/method/coverage/delete/{id} <-- Permanent delete specific row
