 ...
 * Description: Controller Socials REST-API (CRUD)
**/


namespace App\Http\Controllers\API\V1\Socials;
...
// MODELS
use App\Http\Models\API\V1\Socials\M_socials as M_default;


class C_socials extends Controller{

    private $module = "social";
    private $create_required = ['type','url','status','created_by'];

/************* CREATE  *************/

    // [POST] api/social <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/social/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/social/{id} <-- Update specific row
    ...
    // [PUT] api/social/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/social/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/social/delete/{id} <-- Permanent delete specific row
