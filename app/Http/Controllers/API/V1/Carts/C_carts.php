 ...
 * Description: Controller Carts REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Carts\M_carts as M_default;


class C_carts extends Controller{
...
/************* GET/READ  *************/
    ...
    // [GET] api/cart/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/cart/{id} <-- Update specific row
    ...
    // [PUT] api/cart/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/cart/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/cart/delete/{id} <-- Permanent delete specific row
