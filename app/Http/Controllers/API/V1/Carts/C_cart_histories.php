 ...
 * Description: Controller Cart_Histories REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Carts\M_cart_histories as M_default;


class C_cart_histories extends Controller{

    private $module = "cart_history";
    private $create_required = ['product_detail_id','customer_id','status','created_by'];

/************* CREATE  *************/

    // [POST] api/carthistory <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/carthistories <-- Get all lists
    ...
    // [GET] api/carthistory/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/carthistory/{id} <-- Update specific row
    ...
    // [PUT] api/carthistory/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/carthistory/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/carthistory/delete/{id} <-- Permanent delete specific row
