...
namespace App\Http\Controllers\API\V1\Privacy_policies;
...
// MODELS
use App\Http\Models\API\V1\Privacy_policies\M_privacy_policies as M_default;


class C_privacy_policies extends Controller{

    private $module = "privacy_policy";
    private $create_required = ['contents','status','created_by'];

/************* CREATE  *************/

    // [POST] api/privacy_policy <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/privacy_policies <-- Get all lists
    ...
    // [GET] api/privacy_policy/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/privacy_policy/{id} <-- Update specific row
    ...
    // [PUT] api/privacy_policy/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
