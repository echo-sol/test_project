 ...
 * Description: Controller Blog Categories REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Blogs\M_blog_categories as M_default;


class C_blog_categories extends Controller{

    private $module = "blog_category";
    private $create_required = ['blog_id','category_id','status','created_by'];

/************* CREATE  *************/

    // [POST] api/blog/category <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/blog/{id}/categories <-- Get all lists
        function get($reqs, $id, $direct=false){  
            $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/blog/{id}/category <-- Update specific row
    ...
    // [PUT] api/blog/{id}/category/restore <-- Restore deleted specific row
        function restore($id){
...
/************* DELETE  *************/
    ...
    // [DELETE] api/blog/{id}/category <-- SoftDelete specific row
    ...
    // [DELETE] api/blog/{id}/category/delete <-- Permanent delete specific row
