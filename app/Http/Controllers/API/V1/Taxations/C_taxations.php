 ...
 * Description: Controller Taxations REST-API (CRUD)
**/


namespace App\Http\Controllers\API\V1\Taxations;
...
// MODELS
use App\Http\Models\API\V1\Taxations\M_taxations as M_default;


class C_taxations extends Controller{

    private $module = "tax";
    private $create_required = ['tax_name','description','status','created_by'];

/************* CREATE  *************/

    // [POST] api/taxation <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/taxations <-- Get all lists
    ...
    // [GET] api/taxation/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/taxation/{id} <-- Update specific row
    ...
    // [PUT] api/taxation/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/taxation/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/taxation/delete/{id} <-- Permanent delete specific row
