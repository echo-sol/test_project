 ...
 * Description: Controller Payment_Methods REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Payments\M_payment_methods as M_default;


class C_payment_methods extends Controller{

    private $module = "payment_method";
    private $create_required = ['method_name','description','status','created_by'];

/************* CREATE  *************/

    // [POST] api/paymentmethod <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/paymentmethods <-- Get all lists
        function list(Request $reqs){  
            $response = array();

            $paginate = ($reqs->input('paginate') == 'disable') ? false : true;
            $cdata = M_default::where('m_payment_methods.status','<>','0');
    ...
    // [GET] api/paymentmethod/{id} <-- Get specific row
...
/************* UPDATE  *************/
    ...
    // [PUT] api/paymentmethod/{id} <-- Update specific row
    ...
    // [PUT] api/paymentmethod/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/paymentmethod/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/paymentmethod/delete/{id} <-- Permanent delete specific row
