 ...
 * Description: Controller Continents REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Worlds\M_continents as M_default;


class C_continents extends Controller{

    private $module = "continent";
    private $create_required = ['continent_id','name','has_division','status','created_by'];

/************* CREATE  *************/

    // [POST] api/continent <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/continents <-- Get all lists
    ...
    // [GET] api/continent/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/continent/{id} <-- Update specific row
    ...
    // [PUT] api/continent/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/continent/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/continent/delete/{id} <-- Permanent delete specific row
