 ...
 * Description: Controller Countries REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Worlds\M_countries as M_default;


class C_countries extends Controller{

    private $module = "country";
    private $create_required = ['name','has_division','status','created_by'];

/************* CREATE  *************/

    // [POST] api/country <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/countries <-- Get all lists
    ...
    // [GET] api/country/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/country/{id} <-- Update specific row
    ...
    // [PUT] api/country/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/country/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/country/delete/{id} <-- Permanent delete specific row
