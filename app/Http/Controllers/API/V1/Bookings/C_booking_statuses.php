 ...
 * Description: Controller booking_Statuses REST-API (CRUD)
**/
...
// MODELS
use App\Http\Models\API\V1\Bookings\M_booking_statuses as M_default;


class C_booking_statuses extends Controller{

    private $module = "booking_status";
    private $create_required = ['status_name','description','status','created_by'];

/************* CREATE  *************/

    // [POST] api/bookingstatus <-- Create new row
...
/************* GET/READ  *************/
    ...
    // [GET] api/bookingstatuses <-- Get all lists
    ...
    // [GET] api/bookingstatus/{id} <-- Get specific row
    function get($id){
        $response = array();
...
/************* UPDATE  *************/
    ...
    // [PUT] api/bookingstatus/{id} <-- Update specific row
    ...
    // [PUT] api/bookingstatus/restore/{id} <-- Restore deleted specific row
    function restore($id){
        $response = array();
...
/************* DELETE  *************/
    ...
    // [DELETE] api/bookingstatus/{id} <-- SoftDelete specific row
    ...
    // [DELETE] api/bookingstatus/delete/{id} <-- Permanent delete specific row
