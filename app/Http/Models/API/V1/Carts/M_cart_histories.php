 ...
 * Description: Model Cart_Histories REST-API (CRUD)
**/

namespace App\Http\Models\API\V1\Carts;
...
class M_cart_histories extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_cart_histories';
    protected $primaryKey = 'cart_history_id';
