 ...
 * Description: Model Customer_details REST-API (CRUD)
**/

namespace App\Http\Models\API\V1\Customers;
...
class M_customer_details extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_customer_details';
