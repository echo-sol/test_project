 ...
 * Description: Model Customers REST-API (CRUD)
**/

namespace App\Http\Models\API\V1\Conversations;
...
class M_conversations extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_conversations';
