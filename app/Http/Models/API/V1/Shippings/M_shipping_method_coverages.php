 ...
 * Description: Model Shipping Method Coverages REST-API (CRUD)
**/
...
class M_shipping_method_coverages extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_shipping_method_coverages';
    protected $primaryKey = 'shipping_method_coverage';
