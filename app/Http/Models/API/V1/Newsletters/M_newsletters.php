 ...
 * Description: Model Newsletters REST-API (CRUD)
**/

namespace App\Http\Models\API\V1\Newsletters;
...
class M_newsletters extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_newsletters';
