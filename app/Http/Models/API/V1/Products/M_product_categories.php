 ...
 * Description: Model Product_categories REST-API (CRUD)
**/
...
class M_product_categories extends Authenticable{
    ...
    public function harddelete($id){
        ...
        try{
            ...
            if($mdata || empty($dataCheck)){
                ...
                $response["debug"] = "Query to delete product category fail";
            }
