 ...
 * Description: Model Resellers REST-API (CRUD)
**/
...
class M_reseller_details extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_reseller_details';
    protected $primaryKey = 'reseller_detail_id';
