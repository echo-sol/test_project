 ...
 * Description: Model Socials REST-API (CRUD)
**/

namespace App\Http\Models\API\V1\Highscores;
...
class M_highscores extends Authenticable{

    use SoftDeletes;

    protected $table = 'm_highscores';
    protected $primaryKey = 'highscore_id';
